...
<table border="0" cellpadding="2" cellspacing="2">
    ...
    <td><textarea name="place_of_work" id="place_of_work" style="width: 440px; height: 40px; border: 1px solid #ccc;"><?php echo $row['place_of_work']; ?></textarea></td>
    </tr>
    <tr>
    <td align="right"><font style="color: #F00">(*)</font> Địa chỉ </td>
    <td><textarea name="address" id="address" style="width: 440px; height: 40px; border: 1px solid #ccc;" value="<?php echo $row['address']; ?>"></textarea></td>
    </tr>
    <tr>
...
{
	$strSQL1 = "UPDATE contact SET name='".$_POST['name']."',place_of_work='".$_POST['place_of_work']."',address='".$_POST['address']."',tel='".$_POST['tel']."',country='".$_POST['country']."',date=NOW(),state=2 WHERE id ='".$row['id']."'";
