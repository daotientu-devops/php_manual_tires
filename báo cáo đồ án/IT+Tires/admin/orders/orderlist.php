...
<font style="font-size: 18px; font-weight: bold; margin-right: 20px;">Quản lý hóa đơn</font>
<b>[ Thống kê số lượng đơn hàng ] - Tổng số hóa đơn : </b>
<?php
...
<a href="orders.php?action=new" style="font-weight: bold; font-size: 16px;">Thêm mới</a></div>
