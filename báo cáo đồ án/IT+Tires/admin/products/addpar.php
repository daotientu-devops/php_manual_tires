...
<form action="#" method="post" enctype="multipart/form-data">
    ...
    <tr>
    	<td>Tên sản phẩm (*) :</td>
        <td><textarea name="name" id="name" style="width: 600px; height:100px; border: 1px solid #ccc;" class="ckeditor"/><?php echo $row['name']; ?></textarea></td>
    </tr>
    <tr>
    	<td>Nút danh mục (*) :</td>
        <td>
        <select name="catid" style="font-size: 12px; width: 220px; font-family: Arial, Helvetica, sans-serif;">
		...
		while($row2 = mysql_fetch_array($result2))
		{
			...
			while($row3 = mysql_fetch_array($result3))
			{
				...
				while($row4 = mysql_fetch_array($result4))
				{
					...
					{
						echo '<option value="'.$row4['id'].'">&raquo;'.$row4['name'].'</option>';
					}	
				}
			}
		}
    ...
    <tr>
    	<td>Tiêu đề (*) :</td>
        <td><textarea name="title" id="title" style="width: 600px; height:100px; border: 1px solid #ccc;" class="ckeditor"/><?php echo $row['title']; ?></textarea></td>
    </tr>
    <tr>
    	<td>Từ khóa (*) :</td>
        <td><textarea name="keyword" id="keyword" style="width: 600px; height:100px; border: 1px solid #ccc;" class="ckeditor"/><?php echo $row['keyword']; ?></textarea></td>
    </tr>
    <tr>
    	<td>Giá bán (VND) (*) :</td>
    ...
    <tr>
        ...
        <td>
        <label>
        <input name="vat" id="vat" type="radio" value="1" checked />Đã tính
        </label>
        <label>
        <input name="vat" id="vat" type="radio" value="0" />Chưa tính
        </label>
        </td>
    </tr>
    <tr>
    ...
    <tr>
    	<td>Tình trạng :</td>
        <td>
        <select name="status" style="font-size: 12px; width: 40px; font-family: Arial, Helvetica, sans-serif;">
        <option value="">----</option>
    ...
    <tr>
    	<td>Đánh giá :</td>
        <td>
        	<select name="review" style="width: 280px; border: 1px solid #ccc;">
    ...
    <tr>
    	<td>Xuất xứ (Mới) :</td>
        <td>
        <select name="origin" style="font-size: 12px; width: 220px; font-family: Arial, Helvetica, sans-serif;">
        ...
        (Cũ) : 
        <input type="text" style="width: 220px;" value="<?php echo $row['origin']; ?>" disabled="disabled"/>
        </td> 
    </tr>
    <tr>
    	<td>Phí vận chuyển :</td>
        <td>
        	<select name="shipping" style="width: 280px; border: 1px solid #ccc;">
    ...
    <tr>
    	<td></td>
        <td>
        <img src="<?php echo $row['image']; ?>" alt="<?php echo $row['title']; ?>" border="1" />
        </td>
    </tr>
    <tr>
    	<td>Mô tả (*) :</td>
        <td><textarea name="description" id="description" style="width: 600px; height:300px; border: 1px solid #ccc;" class="ckeditor"/><?php echo $row['description']; ?></textarea></td>
    </tr>
    <tr>
        <td>Ngày đăng :</td>
        <td>
    ...
    <table width="100%" border="1" cellspacing="2" cellpadding="2" class="csstable">
    <tr>
    	<td colspan="3"><font style="color: #0004FF;"><h2>Thông số sản phẩm</h2></font></td>
    </tr>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="button" name="btnCancel" id="btnCancel" value="Hủy" onclick="window.location='products.php'" />
        </td>
        <td></td>
    </tr>
    </table>
...
if (isset($_POST['btnUpdate']))
{
	...
	if($file['size']>0)
	{
		$strSQL4 = "UPDATE products SET name='".$_POST['name']."',title='".$_POST['title']."',keyword='".$_POST['keyword']."',price='".$_POST['price']."',VAT='".$_POST['vat']."',amount='".$_POST['amount']."',warranty='".$_POST['warranty']."',status='".$_POST['status']."',review='".$_POST['review']."',origin='".$_POST['origin']."',shipping='".$_POST['shipping']."',image='".$save_path.$file['name']."',description='".$_POST['description']."',date='".$_POST['date']."',state='".$_POST['state']."',typePro='".$_POST['typePro']."',special='".$_POST['special']."',catid='".$_POST['catid']."' WHERE id ='".$row['id']."'";
	}
	else
	{
		$strSQL4 = "UPDATE products SET name='".$_POST['name']."',title='".$_POST['title']."',keyword='".$_POST['keyword']."',price='".$_POST['price']."',VAT='".$_POST['vat']."',amount='".$_POST['amount']."',warranty='".$_POST['warranty']."',status='".$_POST['status']."',review='".$_POST['review']."',origin='".$_POST['origin']."',shipping='".$_POST['shipping']."',description='".$_POST['description']."',date='".$_POST['date']."',state='".$_POST['state']."',typePro='".$_POST['typePro']."',special='".$_POST['special']."',catid='".$_POST['catid']."' WHERE id ='".$row['id']."'";
	}
	$result4 = mysql_query($strSQL4, $link);
