...
<form action="#" method="post" enctype="multipart/form-data">
    ...
    <tr>
    	<td>Tên sản phẩm (*) :</td>
        <td><textarea name="name" id="name" style="width: 600px; height:100px; border: 1px solid #ccc;" class="ckeditor"/></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
    	<td>Title (*) :</td>
        <td><textarea name="title" id="title" style="width: 600px; height:100px; border: 1px solid #ccc;" class="ckeditor"/></textarea></td>
    </tr>
    <tr>
    	<td>Keywords (*) :</td>
        <td><textarea name="keyword" id="keyword" style="width: 600px; height:100px; border: 1px solid #ccc;" class="ckeditor"/></textarea></td>
    </tr>
    <tr>
    	<td>Giá bán (VND) (*) :</td>
    ...
    <tr>
    	<td>Description (*) :</td>
        <td><textarea name="description" id="description" style="width: 600px; height:300px; border: 1px solid #ccc;" class="ckeditor"/></textarea></td>
    </tr>
    <tr>
    	<td>Mô tả sản phẩm (*) :</td>
        <td><textarea name="products_desc" id="products_desc" style="width: 600px; height:300px; border: 1px solid #ccc;" class="ckeditor"/></textarea></td>
    </tr>
    <tr>
        <td>Ngày đăng :</td>
        <td>
