...
<form action="#" method="post" enctype="multipart/form-data">
    ...
    <tr>
        ...
        <td>
        	<input type="text" name="txtNumber" value="<?php if(isset($_POST['txtNumber'])) echo $_POST['txtNumber']; ?>" />
            <input type="submit" name="AcceptNumber" value="Chấp nhận" />
        </td>
    </tr>
    <tr>
    	<td></td>
    ...
    <tr>
        ...
        <td>
        <select name="subid" style="font-size: 12px; width: 220px; font-family: Arial, Helvetica, sans-serif;">
        <option value="">------Select------</option>
        <?php
		$strSQL2 = "SELECT * FROM categories WHERE ParentID = 0";
		$result2 = mysql_query($strSQL2,$link);
    ...
    <tr>
        ...
        (Cũ) : 
        <input type="text" style="width: 220px; border: 1px solid #ccc;" value="<?php echo $row['origin']; ?>"/>
        </td> 
    </tr>
    <tr>
    ...
    <tr>
    	<td></td>
        <td>
        <img src="<?php echo $row['image']; ?>" alt="<?php echo $row['title']; ?>" border="1" width="100px"/>
        </td>
    </tr>
    <!--<tr>
    	<td>Hình ảnh lưu trữ :</td>
    ...
    <tr>
        ...
        <td><textarea name="products_desc" id="products_desc" style="width: 600px; height:300px; border: 1px solid #ccc;" class="ckeditor"/><?php echo $row['products_desc']; ?></textarea></td>
    </tr>
    <tr>
        <td>Ngày đăng :</td>
        <td>
