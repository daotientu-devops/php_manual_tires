...
{
	$strSQL = "SELECT * FROM lessons_readcor WHERE catid='".$_GET['readcordetailid']."' AND state=1";
...
<ul>
	...
	while($row=mysql_fetch_array($result))
	{
		...
		//chuyển đoạn này xuống dưới cho dễ nhìn
		//chỉnh độ rộng cho mỗi txtanswer
		...
		<input type="radio" name="txtanswer10'.$sort.'" id="txtanswer10" style="width: 10px; border: 1px solid #790000;" value="A"/>A'.
		'<input type="hidden" name="id10'.$sort.'" value="'.$row['id'].'">
		&nbsp;
		<input type="radio" name="txtanswer10'.$sort.'" id="txtanswer10" style="width: 10px; border: 1px solid #790000;" value="B"/>B'.
		'<input type="hidden" name="id10'.$sort.'" value="'.$row['id'].'">
		</div>';
		...
		<input type="radio" name="txtanswer8'.$sort.'" id="txtanswer8" style="width: 10px; border: 1px solid #790000;" value="A"/>A'.
		'<input type="hidden" name="id8'.$sort.'" value="'.$row['id'].'">
		&nbsp;
		<input type="radio" name="txtanswer8'.$sort.'" id="txtanswer8" style="width: 10px; border: 1px solid #790000;" value="B"/>B'.
		'<input type="hidden" name="id8'.$sort.'" value="'.$row['id'].'">
		</div>';
		...
		<input type="radio" name="txtanswer9'.$sort.'" id="txtanswer9" style="width: 10px; border: 1px solid #790000;" value="A"/>A'.
		'<input type="hidden" name="id9'.$sort.'" value="'.$row['id'].'">
		&nbsp;
		<input type="radio" name="txtanswer9'.$sort.'" id="txtanswer9" style="width: 10px; border: 1px solid #790000;" value="B"/>B'.
		'<input type="hidden" name="id9'.$sort.'" value="'.$row['id'].'">
		</div>';
