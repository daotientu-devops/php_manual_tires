...
{
	$strSQL = "SELECT * FROM lessons_readdes WHERE catid='".$_GET['readdesdetailid']."' AND state=1";
...
<ul>
	...
	while($row=mysql_fetch_array($result))
	{
		...
		'.
		'<div style="float: left; margin-top: 10px; margin-left: 10px;">Answer is: '.'
		...
		echo '<div style="float: left; width: 618px;">'.$row['description'].'</div>';
