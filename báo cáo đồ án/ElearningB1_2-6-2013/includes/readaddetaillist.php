...
{
	$strSQL = "SELECT * FROM lessons_readad WHERE catid='".$_GET['readaddetailid']."' AND state=1";
...
<ul>
	...
	<?php
	$strSQL = "SELECT * FROM lessons_readad WHERE catid = '".$_GET['readaddetailid']."' AND state=1 LIMIT 0,6";
	$result = mysql_query($strSQL, $link);
	$sort=0;
