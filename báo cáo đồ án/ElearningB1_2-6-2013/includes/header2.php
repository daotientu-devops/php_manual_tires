    ...
    <div class="fix-center">
        ...
        <div id="main-menu">
            <ul>
                ...
                <li><a href="view_testcatlist.php?testid=106">THI THỬ</a></li>
...
<div class="topmenu">
    ...
    <?php
		if(isset($_SESSION['loggedUser']))
		{
			echo 'Xin chào bạn, '.$_SESSION['loggedUser'].'&nbsp;&nbsp;<a href="index.php?action=logout">. Đăng xuất</a>';
		}
		else
		{
...
<!--<div class="slideshow">
	<div id="slide">
        ...
        <img src="images/slideshow/banner13.png" alt="Picture C" border="0"/>
