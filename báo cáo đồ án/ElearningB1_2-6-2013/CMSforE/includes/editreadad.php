...
{
	$strSQL5 = "SELECT * FROM lessons_readad WHERE id='".$_GET['readadid']."'";
...
<form action="#" method="post" enctype="multipart/form-data" name="addcomleft" id="addcomleft">
    ...
    <td align="left"><textarea name="content_ad" id="content_ad" style="width: 400px; height: 100px;border: 1px solid #790000; color: #790000" class="ckeditor"><?php echo $row5['content_ad']; ?></textarea></td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Nội dung câu trả lời: </div></td>
    <td align="left"><textarea name="content_answer" id="content_answer" style="width: 400px; height: 100px;border: 1px solid #790000; color: #790000" class="ckeditor"><?php echo $row5['content_answer']; ?></textarea></td>
    </tr>
   	<tr>
    ...
    <input type="reset" name="reset" value="Hủy bỏ" style="font-family:'Times New Roman', Times, serif" onclick='window.location="lessons_readad.php"'/>
    </td>
    </tr>
    </table>
</form>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql = "UPDATE lessons_readad SET title = '".$_POST['title']."',content_ad = '".$_POST['content_ad']."',content_answer = '".$_POST['content_answer']."',correct_answer = '".$_POST['correct_answer']."',reference = '".$_POST['reference']."',date = '".$_POST['date']."',catid = '".$_POST['Category']."',state = '".$_POST['state']."' WHERE id = '".$row5['id']."'";
