...
{
	$strSQL5 = "SELECT * FROM lessons_writeblank WHERE id='".$_GET['writeblaid']."'";
...
<form action="#" method="post" enctype="multipart/form-data" name="addcomleft" id="addcomleft">
    ...
    <td align="left"><textarea name="question" id="question" style="width: 800px; height: 400px;border: 1px solid #790000; color: #790000" class="ckeditor"><?php echo $row5['question']; ?></textarea></td>
    </tr>
    <tr>
    ...
    <input type="reset" name="reset" value="Hủy bỏ" style="font-family:'Times New Roman', Times, serif" onclick='window.location="lessons_writeblank.php"'/>
    </td>
    </tr>
    </table>
</form>
...
{
	////////////////
	$sql = "UPDATE lessons_writeblank SET title = '".$_POST['title']."',question = '".$_POST['question']."',reference = '".$_POST['reference']."',date = '".$_POST['date']."',catid = '".$_POST['Category']."',state = '".$_POST['state']."' WHERE id = '".$row5['id']."'";
