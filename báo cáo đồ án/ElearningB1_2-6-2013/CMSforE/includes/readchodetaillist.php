...
{
	$strSQL = "SELECT * FROM lessons_readchoose WHERE catid='".$_GET['readchodetailid']."'";
...
<form action="#" method="post">
	...
	while($row=mysql_fetch_array($result))
	{
		...
		echo '<div style="float: left; width: 618px; text-align: left; margin-top: 10px;">'.$row['content_choose'].'</div>';
		echo '<div><b>Answer is:</b></div>';
		echo 
		'<div style="width: 618px; float: left; margin-top: 10px;"><b>'.'1)</b> <input type="text" name="txtanswer1'.$sort.'" id="txtanswer1" style="width: 50px; border: 1px solid #790000;"/>'.
		'<input type="hidden" name="id1'.$sort.'" value="'.$row['id'].'"></div><br/><br/>';
		
		echo 
		'<div style="width: 618px; float: left; margin-top: 10px;"><b>'.'2)</b> <input type="text" name="txtanswer2'.$sort.'" id="txtanswer2" style="width: 50px; border: 1px solid #790000;"/>'.
		'<input type="hidden" name="id2'.$sort.'" value="'.$row['id'].'"></div><br/><br/>';
		
		echo 
		'<div style="width: 618px; float: left; margin-top: 10px;"><b>'.'3)</b> <input type="text" name="txtanswer3'.$sort.'" id="txtanswer3" style="width: 50px; border: 1px solid #790000;"/>'.
		'<input type="hidden" name="id3'.$sort.'" value="'.$row['id'].'"></div><br/><br/>';
		
		echo 
		'<div style="width: 618px; float: left; margin-top: 10px;"><b>'.'4)</b> <input type="text" name="txtanswer4'.$sort.'" id="txtanswer4" style="width: 50px; border: 1px solid #790000;"/>'.
		'<input type="hidden" name="id4'.$sort.'" value="'.$row['id'].'"></div><br/><br/>';
		
		echo 
		'<div style="width: 618px; float: left; margin-top: 10px;"><b>'.'5)</b> <input type="text" name="txtanswer5'.$sort.'" id="txtanswer5" style="width: 50px; border: 1px solid #790000;"/>'.
		'<input type="hidden" name="id5'.$sort.'" value="'.$row['id'].'"></div><br/><br/>';
		
		echo 
		'<div style="width: 618px; float: left; margin-top: 10px;"><b>'.'6)</b> <input type="text" name="txtanswer6'.$sort.'" id="txtanswer6" style="width: 50px; border: 1px solid #790000;"/>'.
		'<input type="hidden" name="id6'.$sort.'" value="'.$row['id'].'"></div><br/><br/>';
		
		echo 
		'<div style="width: 618px; float: left; margin-top: 10px;"><b>'.'7)</b> <input type="text" name="txtanswer7'.$sort.'" id="txtanswer7" style="width: 50px; border: 1px solid #790000;"/>'.
		'<input type="hidden" name="id7'.$sort.'" value="'.$row['id'].'"></div><br/><br/>';
		
		echo 
		'<div style="width: 618px; float: left; margin-top: 10px;"><b>'.'8)</b> <input type="text" name="txtanswer8'.$sort.'" id="txtanswer8" style="width: 50px; border: 1px solid #790000;"/>'.
		'<input type="hidden" name="id8'.$sort.'" value="'.$row['id'].'"></div><br/><br/>';
		
		echo 
		'<div style="width: 618px; float: left; margin-top: 10px;"><b>'.'9)</b> <input type="text" name="txtanswer9'.$sort.'" id="txtanswer9" style="width: 50px; border: 1px solid #790000;"/>'.
		'<input type="hidden" name="id9'.$sort.'" value="'.$row['id'].'"></div><br/><br/>';
		
		echo 
		'<div style="width: 618px; float: left; margin-top: 10px;"><b>'.'10)</b> <input type="text" name="txtanswer10'.$sort.'" id="txtanswer10" style="width: 50px; border: 1px solid #790000;"/>'.
