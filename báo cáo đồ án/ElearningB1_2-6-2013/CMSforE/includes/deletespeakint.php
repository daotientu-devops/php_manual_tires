...
{
	$stSQL = "SELECT * FROM lessons_speakintro WHERE id='".$_GET['speakintid']."'";
...
<div class="conright" style="text-align:center;">
    <form action="#" method="post">
        ...
        <input type="button" name="cancel" value="Hủy bỏ" style="font-family:'Times New Roman', Times, serif" onclick='window.location="lessons_speakintro.php"'/>
        </td>
        </tr>
    	</table>
    </form>
...
{
	$strSQL2 = "DELETE FROM lessons_speakintro WHERE id = '".$row['id']."'";
