...
<form action="#" method="post" enctype="multipart/form-data" name="addcomleft" id="addcomleft">
    ...
    <td align="left"><textarea name="sentence" id="sentence" style="width: 800px; height: 400px;border: 1px solid #790000; color: #790000" class="ckeditor"></textarea></td>
    </tr>
    <tr>
...
if(isset($_POST['submit']))
{
	...
	{
	//kiểm tra có file đc upload hay không
	if($file['name']>0)
	{
		$sql = "INSERT INTO lessons_speaksentence (title, audio, sentence, translate, reference, date, userid, catid, state) 
	values ('".$_POST['title']."','".$save_path.$file['name']."','".$_POST['sentence']."','".$_POST['translate']."','".$_POST['reference']."','".$_POST['date']."','".$_SESSION['log']."','".$_POST['Category']."','".$_POST['state']."')";
	}
	else
	{
		$sql = "INSERT INTO lessons_speaksentence (title, sentence, translate, reference, date, userid, catid, state) 
	values ('".$_POST['title']."','".$_POST['sentence']."','".$_POST['translate']."','".$_POST['reference']."','".$_POST['date']."','".$_SESSION['log']."','".$_POST['Category']."','".$_POST['state']."')";
	}
