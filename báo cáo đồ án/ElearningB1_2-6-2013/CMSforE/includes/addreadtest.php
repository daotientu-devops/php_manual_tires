...
<form action="#" method="post" enctype="multipart/form-data" name="addcomleft" id="addcomleft">
    ...
    <td align="left"><textarea name="sentence" id="sentence" style="width: 400px; height: 100px;border: 1px solid #790000; color: #790000" class="ckeditor"></textarea></td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Đáp án lựa chọn: </div></td>
    <td align="left"><textarea name="select_answer" id="select_answer" style="width: 400px; height: 100px;border: 1px solid #790000; color: #790000" class="ckeditor"></textarea></td>
    </tr>
    <tr>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql = "INSERT INTO lessons_readtest (title, sentence, select_answer, correct_answer, reference, date, userid, catid, state) 
	values ('".$_POST['title']."','".$_POST['sentence']."','".$_POST['select_answer']."','".$_POST['correct_answer']."','".$_POST['reference']."','".$_POST['date']."','".$_SESSION['log']."','".$_POST['Category']."','".$_POST['state']."')";
