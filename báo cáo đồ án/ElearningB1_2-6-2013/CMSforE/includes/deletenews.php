...
if(isset($_GET['nid']))
{
	$stSQL = "SELECT * FROM news WHERE id='".$_GET['nid']."'";
...
<div class="conright" style="text-align:center;">
    <form action="#" method="post">
        ...
        <input type="button" name="cancel" value="Hủy bỏ" style="font-family:'Times New Roman', Times, serif" onclick='window.location="news.php"'/>
        </td>
        </tr>
    	</table>
    </form>
