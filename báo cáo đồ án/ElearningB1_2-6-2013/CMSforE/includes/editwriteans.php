...
{
	$strSQL5 = "SELECT * FROM lessons_writeanswer WHERE id='".$_GET['writeansid']."'";
...
<form action="#" method="post" enctype="multipart/form-data" name="addcomleft" id="addcomleft">
    ...
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Câu hỏi: </div></td>
    ...
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Trả lời mẫu: </div></td>
    <td align="left"><textarea name="content_answer" id="content_answer" style="width: 800px; height: 400px;border: 1px solid #790000; color: #790000" class="ckeditor"><?php echo $row5['content_answer']; ?></textarea></td>
    </tr>
    ...
    <input type="reset" name="reset" value="Hủy bỏ" style="font-family:'Times New Roman', Times, serif" onclick='window.location="lessons_writeanswer.php"'/>
    </td>
    </tr>
    </table>
</form>
...
{
	////////////////
	$sql = "UPDATE lessons_writeanswer SET title = '".$_POST['title']."',content_question = '".$_POST['content_question']."',content_answer = '".$_POST['content_answer']."',reference = '".$_POST['reference']."',date = '".$_POST['date']."',catid = '".$_POST['Category']."',state = '".$_POST['state']."' WHERE id = '".$row5['id']."'";
