...
{
	$strSQL5 = "SELECT * FROM lessons_speakintro WHERE id='".$_GET['speakintid']."'";
...
<form action="#" method="post" enctype="multipart/form-data" name="addcomleft" id="addcomleft">
    ...
    <td align="left"><textarea name="requirement" id="requirement" style="width: 800px; height: 400px;border: 1px solid #790000; color: #790000" class="ckeditor"><?php echo $row5['requirement']; ?></textarea></td>
    </tr>
    <tr>
    ...
    <input type="reset" name="reset" value="Hủy bỏ" style="font-family:'Times New Roman', Times, serif" onclick='window.location="lessons_speakintro.php"'/>
    </td>
    </tr>
    </table> 
</form>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql = "UPDATE lessons_speakintro SET title = '".$_POST['title']."',requirement = '".$_POST['requirement']."',reference = '".$_POST['reference']."',date = '".$_POST['date']."',catid = '".$_POST['Category']."',state = '".$_POST['state']."' WHERE id = '".$row5['id']."'";
