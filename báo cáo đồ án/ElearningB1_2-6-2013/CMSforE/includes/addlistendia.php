...
if(isset($_POST['submit']))
{
	...
	if($file['size']>0)
	{
		$sql = "INSERT INTO lessons_listendialog (title, audio, content_question, translate, cor1, cor2, cor3, cor4, cor5, cor6, reference, date, userid, catid, state) 
	values ('".$_POST['title']."','".$save_path.$file['name']."','".$_POST['content_question']."','".$_POST['translate']."','".$_POST['cor1']."','".$_POST['cor2']."','".$_POST['cor3']."','".$_POST['cor4']."','".$_POST['cor5']."','".$_POST['cor6']."','".$_POST['reference']."','".$_POST['date']."','".$_SESSION['log']."','".$_POST['Category']."','".$_POST['state']."')";
	}
	else
	{
		$sql = "INSERT INTO lessons_listendialog (title, content_question, translate, cor1, cor2, cor3, cor4, cor5, cor6, reference, date, userid, catid, state) 
	values ('".$_POST['title']."','".$_POST['content_question']."','".$_POST['translate']."','".$_POST['cor1']."','".$_POST['cor2']."','".$_POST['cor3']."','".$_POST['cor4']."','".$_POST['cor5']."','".$_POST['cor6']."','".$_POST['reference']."','".$_POST['date']."','".$_SESSION['log']."','".$_POST['Category']."','".$_POST['state']."')";
