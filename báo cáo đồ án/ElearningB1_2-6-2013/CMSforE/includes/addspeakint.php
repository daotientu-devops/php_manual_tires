...
<form action="#" method="post" enctype="multipart/form-data" name="addcomleft" id="addcomleft">
    ...
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Yêu cầu chung: </div></td>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql = "INSERT INTO lessons_speakintro (title, requirement, reference, date, userid, catid, state) 
	VALUES ('".$_POST['title']."','".$_POST['requirement']."','".$_POST['reference']."','".$_POST['date']."','".$_SESSION['log']."','".$_POST['Category']."','".$_POST['state']."')";
