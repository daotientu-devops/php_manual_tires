...
<table border="0" cellpadding="2" cellspacing="2" style="padding-top: 0px; padding-left: 0px;">
    ...
    <td align="left"><textarea name="content_question" id="content_question" style="width: 400px; height: 100px;border: 1px solid #790000; color: #790000" class="ckeditor"></textarea></td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Câu trả lời mẫu: </div></td>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql = "INSERT INTO lessons_writeanswer (title, content_question, content_answer, reference, date, userid, catid, state) 
	values ('".$_POST['title']."','".$_POST['content_question']."','".$_POST['content_answer']."','".$_POST['reference']."','".$_POST['date']."','".$_SESSION['log']."','".$_POST['Category']."','".$_POST['state']."')";
