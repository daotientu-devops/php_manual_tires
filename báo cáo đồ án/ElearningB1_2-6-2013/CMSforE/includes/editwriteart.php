...
{
	$strSQL5 = "SELECT * FROM lessons_writearticle WHERE id='".$_GET['writeartid']."'";
...
<form action="#" method="post" enctype="multipart/form-data" name="addcomleft" id="addcomleft">
    ...
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Đề bài gợi ý: </div></td>
    <td align="left"><textarea name="suggestion" id="suggestion" style="width: 800px; height: 100px;border: 1px solid #790000; color: #790000" class="ckeditor"><?php echo $row5['suggestion']; ?></textarea></td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Yêu cầu: </div></td>
    <td align="left"><textarea name="requirement" id="requirement" style="width: 800px; height: 100px;border: 1px solid #790000; color: #790000" class="ckeditor"><?php echo $row5['requirement']; ?></textarea></td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Bài mẫu: </div></td>
    <td align="left"><textarea name="sample" id="sample" style="width: 400px; height: 100px;border: 1px solid #790000; color: #790000" class="ckeditor"><?php echo $row5['sample']; ?></textarea></td>
    </tr>
    <tr>
    ...
    <input type="reset" name="reset" value="Hủy bỏ" style="font-family:'Times New Roman', Times, serif" onclick='window.location="lessons_writearticle.php"'/>
    </td>
    </tr>
    </table>
</form>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql = "UPDATE lessons_writearticle SET title = '".$_POST['title']."',suggestion = '".$_POST['suggestion']."',requirement = '".$_POST['requirement']."',sample = '".$_POST['sample']."',reference = '".$_POST['reference']."',date = '".$_POST['date']."',catid = '".$_POST['Category']."',state = '".$_POST['state']."' WHERE id = '".$row5['id']."'";
