...
{
	$strSQL5 = "SELECT * FROM lessons_readchoose WHERE id='".$_GET['readchoid']."'";
...
<form action="#" method="post" enctype="multipart/form-data" name="addcomleft" id="addcomleft">
    ...
    <td align="left"><textarea name="content_choose" id="content_choose" style="width: 800px; height: 400px;border: 1px solid #790000; color: #790000" class="ckeditor"><?php echo $row5['content_choose']; ?></textarea></td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Chọn lựa 1: </div></td>
    <td align="left"><input type="text" name="choose1" id="choose1" style="width: 200px; border: 1px solid #790000;" value="<?php  echo $row5['choose1']; ?>"/> </td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Chọn lựa 2: </div></td>
    <td align="left"><input type="text" name="choose2" id="choose2" style="width: 200px; border: 1px solid #790000;" value="<?php  echo $row5['choose2']; ?>"/> </td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Chọn lựa 3: </div></td>
    <td align="left"><input type="text" name="choose3" id="choose3" style="width: 200px; border: 1px solid #790000;" value="<?php  echo $row5['choose3']; ?>"/> </td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Chọn lựa 4: </div></td>
    <td align="left"><input type="text" name="choose4" id="choose4" style="width: 200px; border: 1px solid #790000;" value="<?php  echo $row5['choose4']; ?>"/> </td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Chọn lựa 5: </div></td>
    <td align="left"><input type="text" name="choose5" id="choose5" style="width: 200px; border: 1px solid #790000;" value="<?php  echo $row5['choose5']; ?>"/> </td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Chọn lựa 6: </div></td>
    <td align="left"><input type="text" name="choose6" id="choose6" style="width: 200px; border: 1px solid #790000;" value="<?php  echo $row5['choose6']; ?>"/> </td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Chọn lựa 7: </div></td>
    <td align="left"><input type="text" name="choose7" id="choose7" style="width: 200px; border: 1px solid #790000;" value="<?php  echo $row5['choose7']; ?>"/> </td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Chọn lựa 8: </div></td>
    <td align="left"><input type="text" name="choose8" id="choose8" style="width: 200px; border: 1px solid #790000;" value="<?php  echo $row5['choose8']; ?>"/> </td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Chọn lựa 9: </div></td>
    <td align="left"><input type="text" name="choose9" id="choose9" style="width: 200px; border: 1px solid #790000;" value="<?php  echo $row5['choose9']; ?>"/> </td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Chọn lựa 10: </div></td>
    <td align="left"><input type="text" name="choose10" id="choose10" style="width: 200px; border: 1px solid #790000;" value="<?php  echo $row5['choose10']; ?>"/> </td>
    </tr>
    <tr>
    ...
    <input type="reset" name="reset" value="Hủy bỏ" style="font-family:'Times New Roman', Times, serif" onclick='window.location="lessons_readchoose.php"'/>
    </td>
    </tr>
    </table>
</form>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql = "UPDATE lessons_readchoose SET title = '".$_POST['title']."',text = '".$_POST['text']."',content_choose = '".$_POST['content_choose']."',choose1 = '".$_POST['choose1']."',choose2 = '".$_POST['choose2']."',choose3 = '".$_POST['choose3']."',choose4 = '".$_POST['choose4']."',choose5 = '".$_POST['choose5']."',choose6 = '".$_POST['choose6']."',choose7 = '".$_POST['choose7']."',choose8 = '".$_POST['choose8']."',choose9 = '".$_POST['choose9']."',choose10 = '".$_POST['choose10']."',reference = '".$_POST['reference']."',date = '".$_POST['date']."',catid = '".$_POST['Category']."',state = '".$_POST['state']."' WHERE id = '".$row5['id']."'";
