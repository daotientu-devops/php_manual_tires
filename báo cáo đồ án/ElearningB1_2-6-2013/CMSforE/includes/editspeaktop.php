<?php
if(isset($_GET['speaktopid']))
{
	$strSQL5 = "SELECT * FROM lessons_speaktopic WHERE id='".$_GET['speaktopid']."'";
...
<form action="#" method="post" enctype="multipart/form-data" name="addcomleft" id="addcomleft">
    ...
    <td align="left"><textarea name="topic_name" id="topic_name" style="width: 800px; height: 400px;border: 1px solid #790000; color: #790000" class="ckeditor"><?php echo $row5['topic_name']; ?></textarea></td>
    </tr>
    
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Bài nói mẫu: </div></td>
    <td align="left"><textarea name="sample" id="sample" style="width: 800px; height: 400px;border: 1px solid #790000; color: #790000" class="ckeditor"><?php echo $row5['sample']; ?></textarea></td>
    </tr>
    <tr>
   	<td align="right"><div style="font-weight: bold; color: #790000">Video:</div></td>
    <td align="left"><input name="media" id="media" type="file" style="width: 800px; border: 1px solid #790000; color: #790000;"/>
    </td>
    </tr>
    <tr>
   	<td align="right"></td>
    <td align="left"><input type="text" style="width: 600px; border: 1px solid #790000; color: #790000;" value="<?php echo $row5['media']; ?>" /></td>
    </tr>
    <tr>
    <td align="right"><div style="font-weight: bold; color: #790000">Phần dịch: </div></td>
    ...
    <input type="reset" name="reset" value="Hủy bỏ" style="font-family:'Times New Roman', Times, serif" onclick='window.location="lessons_speaktopic.php"'/>
    </td>
    </tr>
    </table>
</form>
...
if(isset($_POST['submit']))
{
	...
	if($file['size']>0)
	{
		$sql = "UPDATE lessons_speaktopic SET title = '".$_POST['title']."',topic_name = '".$_POST['topic_name']."',sample = '".$_POST['sample']."',media = '".$save_path.$file['name']."',translate = '".$_POST['translate']."',reference = '".$_POST['reference']."',date = '".$_POST['date']."',catid = '".$_POST['Category']."',state = '".$_POST['state']."' WHERE id = '".$row5['id']."'";
	}
	else
	{
		$sql = "UPDATE lessons_speaktopic SET title = '".$_POST['title']."',topic_name = '".$_POST['topic_name']."',sample = '".$_POST['sample']."',translate = '".$_POST['translate']."',reference = '".$_POST['reference']."',date = '".$_POST['date']."',catid = '".$_POST['Category']."',state = '".$_POST['state']."' WHERE id = '".$row5['id']."'";
	}
