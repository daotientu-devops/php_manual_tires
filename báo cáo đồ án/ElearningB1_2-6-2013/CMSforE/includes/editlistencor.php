<?php
if(isset($_GET['listencorid']))
{
	$strSQL5 = "SELECT * FROM lessons_listencor WHERE id='".$_GET['listencorid']."'";
...
<form action="#" method="post" enctype="multipart/form-data" id="form_listencorrect">
    ...
    <input type="reset" name="reset" value="Hủy bỏ" style="font-family:'Times New Roman', Times, serif" onclick='window.location="lessons_listencorrect.php"'/>
    </td>
    </tr>
    </table>
</form>
...
if(isset($_POST['submit']))
{
	...
	if($file['size']>0)
	{
		$sql = "UPDATE lessons_listencor SET title = '".$_POST['title']."',audio = '".$save_path.$file['name']."',sentences = '".$_POST['sentences']."',translate = '".$_POST['translate']."',cor1 = '".$_POST['cor1']."',cor2 = '".$_POST['cor2']."',cor3 = '".$_POST['cor3']."',cor4 = '".$_POST['cor4']."',cor5 = '".$_POST['cor5']."',cor6 = '".$_POST['cor6']."',reference = '".$_POST['reference']."',date = '".$_POST['date']."',catid = '".$_POST['Category']."',state = '".$_POST['state']."' WHERE id = '".$row5['id']."'";
	}
	else
	{
		$sql = "UPDATE lessons_listencor SET title = '".$_POST['title']."',sentences = '".$_POST['sentences']."',translate = '".$_POST['translate']."',cor1 = '".$_POST['cor1']."',cor2 = '".$_POST['cor2']."',cor3 = '".$_POST['cor3']."',cor4 = '".$_POST['cor4']."',cor5 = '".$_POST['cor5']."',cor6 = '".$_POST['cor6']."',reference = '".$_POST['reference']."',date = '".$_POST['date']."',catid = '".$_POST['Category']."',state = '".$_POST['state']."' WHERE id = '".$row5['id']."'";
	}
