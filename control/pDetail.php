                ...
                <table width="100%" border="1" cellpadding="4" cellspacing="4" class="csstable">
                	<tr>
                        ...
                        <td>
							<?php 
								if($fc['type']==1){
									echo 'P(Passenger): lốp xe chở khách';	
								}elseif($fc['type']==2){
									echo 'LT(Light Truck): xe tải nhẹ';
								}elseif($fc['type']==3){
									echo 'T(Temporary): lốp thay thế tạm thời';
								} 
							?>
                    	</td>
                    </tr>
                	<tr>
                        ...
                        <td><?php echo $fc['width_tires']; ?></td>
                    </tr>
                    <tr>
                    	<td>Tỷ lệ bề dày/chiều rộng lốp(%) :</td>
                        <td><?php echo $fc['rate']; ?></td>
                    </tr>
                    <tr>
                    	<td>Cấu tạo lốp :</td>
                        <td>
							<?php 
								if($fc['tire_structure']==1){
									echo 'R(hướng tâm) : các lớp bố thân lốp xe chạy hướng tâm từ ta-lông bên này sang ta-lông bên kia';	
								}elseif($fc['tire_structure']==2){
									echo 'B(bố xiên) : các lớp bố xiên chạy xiên từ ta-lông bên này sang ta-lông bên kia, với các lớp bố lần lượt đổi hướng để gia cường lẫn nhau';
								}
							?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><?php echo $fc['diameter_wheels']; ?></td>
                    </tr>
                    <tr>
                    	<td>Chỉ số trọng tải(kg) hoặc pound(cân Anh) :</td>
                        <td><?php echo $fc['tonnage_index']; ?></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                        	<?php 
								if($fc['speed_index']==1){
									echo 'F (vận tốc tối đa: 80 km/h)';	
								}elseif($fc['speed_index']==2){
									echo 'G (vận tốc tối đa: 90 km/h)';
								}elseif($fc['speed_index']==3){
									echo 'J (vận tốc tối đa: 100 km/h)';
								}elseif($fc['speed_index']==4){
									echo 'K (vận tốc tối đa: 110 km/h)';
								}elseif($fc['speed_index']==5){
									echo 'L (vận tốc tối đa: 120 km/h)';
								}elseif($fc['speed_index']==6){
									echo 'M (vận tốc tối đa: 130 km/h)';
								}elseif($fc['speed_index']==7){
									echo 'N (vận tốc tối đa: 140 km/h)';
								}elseif($fc['speed_index']==8){
									echo 'P (vận tốc tối đa: 150 km/h)';
								}elseif($fc['speed_index']==9){
									echo 'Q (vận tốc tối đa: 160 km/h)';
								}elseif($fc['speed_index']==10){
									echo 'R (vận tốc tối đa: 170 km/h)';
								}elseif($fc['speed_index']==11){
									echo 'S (vận tốc tối đa: 180 km/h)';
								}elseif($fc['speed_index']==10){
									echo 'T (vận tốc tối đa: 190 km/h)';
								}elseif($fc['speed_index']==11){
									echo 'U (vận tốc tối đa: 200 km/h)';
								}elseif($fc['speed_index']==10){
									echo 'H (vận tốc tối đa: 210 km/h)';
								}elseif($fc['speed_index']==11){
									echo 'V (vận tốc tối đa: 240 km/h)';
								}elseif($fc['speed_index']==10){
									echo 'Z (vận tốc tối đa: > 240 km/h)';
								}
							?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                        	<?php 
								if($fc['treadwear']==1){
									echo 'Trên 100 - Tốt hơn';	
								}elseif($fc['treadwear']==2){
									echo '100 - Mức chuẩn';
								}elseif($fc['treadwear']==3){
									echo 'Dưới 100 - Kém hơn';
								}
							?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                        	<?php 
								if($fc['traction']==1){
									echo 'A - Tốt nhất';	
								}elseif($fc['traction']==2){
									echo 'B - Trung bình';
								}elseif($fc['traction']==3){
									echo 'C - Chấp nhận được';
								}
							?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                        	<?php 
								if($fc['temperature']==1){
									echo 'A - Tốt nhất';	
								}elseif($fc['temperature']==2){
									echo 'B - Trung bình';
								}elseif($fc['temperature']==3){
									echo 'C - Chấp nhận được';
								}
							?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><?php echo $fc['ms']; ?></td>
                    </tr>
                    <tr>
                    	<td>Tải trọng tối đa của lốp xe - pound hoặc kg :</td>
                        <td><?php echo $fc['maximum_load']; ?></td>
                    </tr>
                    <tr>
                    	<td>Áp lực hơi tối đa :</td>
                        <td><?php echo $fc['maximum_pressure']; ?></td>
                    </tr>
                </table>
        	</div>
        </div>
