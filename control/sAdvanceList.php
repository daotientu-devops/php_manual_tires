...
<form action="searchList.php" method="get">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="keyword" id="keyword" style="width: 280px; border: 1px solid #ccc;"/> 
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
        	<textarea name="products_desc" style="width:280px;border:1px solid #ccc;"></textarea>
        </td>
    </tr>
    <tr>
        <td align="right"></td>
        <td>
            <input type="submit" name="btnSubmit_SearchAdvance" id="btnSubmit" value="Tìm kiếm"/> 
        </td>
    </tr>
    </table>
</form>
