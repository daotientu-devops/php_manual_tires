...
<h3>Hồ sơ cá nhân của bạn, <font style="color: #0004FF; text-decoration: underline;"><?php echo $_SESSION['id']; ?></font></h3>
</div>
...
{
	$strSQL4 = "UPDATE users SET username='".$_POST['username']."',name='".$_POST['name']."',password='".md5($_POST['password'])."',email='".$_POST['email']."' WHERE id ='".$_SESSION['id']."'";
