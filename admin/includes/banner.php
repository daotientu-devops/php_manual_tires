...
<?php
    ...
    <?php
		...
		{
			echo 'Xin chào bạn, '.$_SESSION['username'].'&nbsp;&nbsp;|&nbsp;<a href="login.php?action=logout"> Đăng xuất</a>&nbsp;&nbsp;|&nbsp;<a target="_blank" href="../index.php"> Về trang web</a>';
		}
		elseif(isset($_COOKIE['id']))
		{
			echo 'Xin chào bạn, '.$_COOKIE['username'].'&nbsp;&nbsp;|&nbsp;<a href="login.php?action=logout"> Đăng xuất</a>&nbsp;&nbsp;|&nbsp;<a target="_blank" href="../index.php"> Về trang web</a>';
		}
	?>
</div>
