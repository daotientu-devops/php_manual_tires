...
<ul>
	<?php //http://forum.nukeviet.vn/viewtopic.php?f=117&t=22256
	$p=15;
	if(isset($_GET['n']))
	{
		$n=$_GET['n'];	
	...
	//
	if(isset($_GET['products_desc'])){
		$_GET['products_desc']=mysql_escape_string($_GET['products_desc']);
		$sql1.=" AND products_desc like '%".$_GET['products_desc']."%'";
	}
	...
	if(isset($_GET['btnSubmit_SearchAdvance']))
	{}else{view_page();}
	echo '</li>';
	?>
</ul>
