...
<div class="content_cart">
    ...
    <?php
		...
		{
				echo '(';
				echo '<a href="cart.php?cid=">'.$_SESSION['numberPro'];
				echo ' sản phẩm</a>)';
		}
		else
		{
...
<div class="content_selling">
	...
	for($i=1;$i<=5;$i++)
	{
		if($i==1)
		{
			...
			<div class="index"><font size="+2"><b>1</b></font></div>
			<a href="productDetail.php?pid='.$row['id'].'"><img src="admin/'.$row['image'].'" /></a>
			<div class="product_name">
			<a href="productDetail.php?pid='.$row['id'].'">'.$row['name'].'</a>
			</div>
			</li>';
			}
		}
		else
		{
			...
			while($row1=mysql_fetch_array($query1))
			{
				...
				<div class="product_name">
				<a href="productDetail.php?pid='.$row1['id'].'">'.$row1['name'].'</a>
				</div>
				</li> ';
			}
		}
...
<div class="content_news">
	...
	{
		echo '<li>';
		echo '<div class="image"><a href="newsDetail.php?nid='.$row2['id'].'"><img src="admin/'.$row2['picture'].'" alt="'.$row2['title'].'" border="1" width="60px" style="border: 1px solid #ccc;"/></a></div>';
		echo '<div class="title"><a href="newsDetail.php?nid='.$row2['id'].'">'.$row2['title'].'</a></div>';
		echo '</li>';
